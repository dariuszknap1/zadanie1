...
mongoose.connect('mongodb+srv://admin:admin@cluster0.sznzc.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', connectionParams);
var fs = require('fs');
...
app.listen(2000, () => {
  ...
  console.log(date + " - Dariusz Knap - W celu komunikacji z serwerem proszę użyć portu 3000, localhost:3000.");
});
